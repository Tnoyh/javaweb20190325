...
@WebServlet("/login")    //前面加个斜杆，斜杆是从项目开始的，使用websetvlet 用注解的形式起个名字,login.html里面调用就用login这个名字
public class MyServlet01 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //响应嘛，用HttpServletResponse

        /**  ！！！！！！！
         * 1: 文件内容的类型：setContentType
         * 2: 字符编码：setCharacterEncoding
         * 3：通过resp.getWriter方法得到PrintWriter对象,从网页输出内容
         *     out.print进行输出的时候，
        ...
        PrintWriter out = resp.getWriter();//通过getWriter方法，写、得到write值，就可以把我们要输出的值放到页面上了，也就是text/html
        out.print("<html>");
        out.print("<head>");
